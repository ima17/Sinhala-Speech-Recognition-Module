...
from utils import calc_feat_dim, spectrogram_from_file, text_to_int_sequence, mfcc_from_file
...
class AudioGenerator:
    ...
    def featurize(self, audio_clip):
        ...
        if self.spectrogram:
            ...
            return mfcc_from_file(sig, rate, numcep=self.mfcc_dim)

    def normalize(self, feature, eps=1e-14):
        #print(feature - self.feats_mean)
...
def vis_train_features():
    ...
    vis_audio_path = "D:\\level4_sem1\\project_interim2\\dataset_final\\dataset_train_final\\01\\104\\01_104_1.wav"
